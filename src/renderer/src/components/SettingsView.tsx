...
import { applyTheme, applyUiFontScale, applyAccentColor, applyUiZoom } from '../lib/apply-theme'
...
export function SettingsView(): ReactElement {
  ...
  useEffect(() => {
    ...
    if (formUiZoom != null) applyUiZoom(formUiZoom)
    if (formAccentColor) {
      applyAccentColor(formAccentColor)
    }
  }, [formTheme, formUiFontScale, formUiZoom, formAccentColor])
